...
### Docker Stack (`/opt/openaec/docker-compose.yml`)
```
...
│   └── customer/   # BIC table, cost summary, location detail, object description
...
│   └── brands/customer/  # Customer brand.yaml, stationery, logos
...
| **modules/customer/** | ✅ Compleet | ✅ test_customer_modules.py (32 tests) | — |
...
├── test_customer_modules.py       ✅ 32 tests
├── test_customer_brand.py         ✅ 16 tests
├── test_customer_integration.py   ✅ 14 tests
└── test_customer_templates.py     ✅ 21 tests
```
...
- **Customer tenant:** 4 modules (bic_table, cost_summary, location_detail, object_description), brand.yaml, 2 rapport templates
