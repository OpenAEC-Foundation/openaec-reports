...
- [ ] **CR-H1** — 15+ hardcoded "3bm_cooperatie" / "3BM Bouwkunde" in codebase
...
- [ ] **CR-M10** — JSON Schema: `$id` en `title` nog "3BM" in report.schema.json
...
- [ ] **CR-M23** — `__init__.py` docstring noemt nog "3BM Report Generator"
...
- [ ] **CR-L3** — Frontend: SpreadsheetEditor BG_COLORS bevat hardcoded 3BM kleuren (#40124A)
...
- [ ] **CR-L8** — Symitech brand.yaml: fonts refereren Helvetica maar font_files laden Arial
...
- [ ] Q8 — Default brand configureerbaar maken via `OPENAEC_DEFAULT_BRAND` env var (nu hardcoded `"3bm_cooperatie"`)
