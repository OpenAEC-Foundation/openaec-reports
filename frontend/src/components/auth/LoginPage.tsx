        ...
        <div className="rounded-xl border border-gray-200 bg-white p-8 shadow-sm">
          ...
          {oidcEnabled !== false && (
            <button
              ...
              className="flex w-full items-center justify-center gap-2 rounded-lg px-4 py-2.5 text-sm font-medium text-white transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
