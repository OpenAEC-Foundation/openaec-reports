...
JWT_SECRET_KEY = os.environ.get("OPENAEC_JWT_SECRET", _DEFAULT_SECRET)
JWT_ALGORITHM = "HS256"
ACCESS_TOKEN_EXPIRE_MINUTES = int(
    os.environ.get("OPENAEC_TOKEN_EXPIRE_MINUTES", "480")
)
...
def get_cookie_secure() -> bool:
    ...
    """
    return os.environ.get("OPENAEC_COOKIE_SECURE", "true").lower() == "true"
