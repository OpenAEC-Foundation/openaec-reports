  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <div className="flex items-center gap-2">
        <svg className="h-5 w-5 text-oaec-text-faint" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        ...
        <h2 className="text-lg font-semibold text-oaec-text">Rapport instellingen</h2>
      </div>

      {/* Template selector */}
      <TemplateSelector />
      <hr className="border-oaec-border-subtle" />
            ...
            {(['A4', 'A3'] as Format[]).map((fmt) => (
              <label key={fmt} className="flex items-center gap-1.5 cursor-pointer">
                <input
                  ...
                  className="h-3.5 w-3.5 text-oaec-accent focus:ring-oaec-accent/20"
                />
                <span className="text-sm text-oaec-text-secondary">{fmt}</span>
              </label>
            ))}
          </div>
        </div>
            ...
            {([
              ...
              <label key={opt.value} className="flex items-center gap-1.5 cursor-pointer">
                <input
                  ...
                  className="h-3.5 w-3.5 text-oaec-accent focus:ring-oaec-accent/20"
                />
                <span className="text-sm text-oaec-text-secondary">{opt.label}</span>
              </label>
            ))}
          </div>
        </div>
