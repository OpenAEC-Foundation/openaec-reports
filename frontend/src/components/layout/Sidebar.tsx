  ...
  return (
    <aside className="flex h-full w-72 flex-col border-r border-gray-200 bg-white">
      ...
      <div className="border-t border-gray-200 px-4 py-2">
        <button
          onClick={() => useReportStore.getState().setViewMode('brand-wizard')}
          className="flex w-full items-center gap-2 rounded-md px-2 py-1.5 text-xs font-medium text-gray-500 transition-colors hover:bg-gray-50 hover:text-gray-700"
        >
