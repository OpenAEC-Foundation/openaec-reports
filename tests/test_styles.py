...
class TestCreateStylesheet:
    ...
    def test_3bm_brand_overrides(self):
        brand = BrandConfig(styles={
            "Normal": {"fontName": "GothamBook", "fontSize": 9.5, "textColor": "#45243D"},
            "Heading1": {"fontName": "GothamBook", "fontSize": 18.0, "textColor": "#45243D"},
            "Heading2": {"fontName": "GothamBook", "fontSize": 13.0, "textColor": "#56B49B"},
        })
        styles = create_stylesheet(brand=brand)
        assert styles["Normal"].fontSize == 9.5
        assert styles["Heading1"].fontSize == 18.0
