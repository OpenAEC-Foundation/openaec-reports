...
# Prefix voor herkenbare keys (bijv. "oaec_k_abc123...")
API_KEY_PREFIX = "oaec_k_"
...
def generate_api_key() -> str:
    ...
    Returns:
        API key string (bijv. "oaec_k_a1b2c3d4e5f6...").
    """
...
class ApiKey:
    ...
    name: str = ""
    key_hash: str = ""
    key_prefix: str = ""  # Eerste 12 chars voor identificatie (bijv. "oaec_k_a1b2")
