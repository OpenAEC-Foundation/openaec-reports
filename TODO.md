...
- [ ] `npm run build` met `VITE_API_URL=https://report.open-aec.com`
- [ ] Dist bestanden uploaden naar server: `/opt/openaec/bm-reports-ui/dist/`
- [ ] Verifiëren: https://report.open-aec.com laadt frontend
...
Architectureel kritiek voor multi-tenant SaaS. Huidige situatie: alle client-specifieke assets (templates, brands, fonts, stationery) zitten gebundeld in het Python package. Andere bedrijven zouden OpenAEC's templates zien.
...
- [ ] Stap 5: Assets migreren naar `tenants/default/`
