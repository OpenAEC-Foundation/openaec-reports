...
- Afgeronde taken deze sessie:
  - **Tenant-scheiding** (PROMPT_TENANT_SEPARATION.md):
    - `core/tenant.py`: TenantConfig class met OPENAEC_TENANT_DIR env var
...
- Klantspecifieke assets verwijderen uit `src/openaec_reports/assets/` (na migratie bevestiging)
