...
**Fix:** De API moet `template` en `brand` ontkoppelen. Hardcode brand op `"3bm_cooperatie"` of voeg een apart `brand` veld toe aan de frontend.
...
1. In api.py: ontkoppel template/brand - gebruik altijd "3bm_cooperatie" als brand,
