...
Usage::
    ...
    from openaec_reports.modules.yaml_module import create_yaml_module_class
    ...
    ModuleRegistry.register_tenant("customer", "location_detail", LocationDetail)
...
class YamlModule(ContentModule):
    ...
    def _draw_double_line(self, y: float) -> None:
        """Draw a double horizontal line (Customer style separator)."""
        c = self.canv
