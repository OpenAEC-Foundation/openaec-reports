...
def simple_page():
    ...
    return RawPageData(
        ...
        height_pt=842.0,
        texts=[
            TextElement("Titel", 50, 200, 300, 230, "Inter-Bold", 28.0, "#40124A"),
            TextElement("Subtitel", 50, 240, 300, 260, "Inter-Book", 16.0, "#45243D"),
        ],
        rects=[
...
def page_with_badges():
    ...
    return RawPageData(
        ...
        height_pt=842.0,
        texts=[
            TextElement("betrouwbaar", 105, 610, 200, 625, "Inter-Bold", 9.0, "#FFFFFF"),
        ],
        rects=[
...
def sample_pdf(tmp_path) -> Path:
    ...
    page.insert_text(fitz.Point(50, 320), "www.open-aec.com", fontsize=10)
