...
# Rapport genereren
openaec-report generate --template structural --data examples/3bm_cooperatie/structural_report.json --output output/test.pdf
```
...
export OPENAEC_TENANT_DIR=tenants/3bm_cooperatie
...
| `src/openaec_reports/core/fonts.py` | Gotham font registratie + Helvetica fallback |
