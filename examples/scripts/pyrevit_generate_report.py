"""pyRevit voorbeeld: rapport genereren via de OpenAEC Report API.
...
API_URL = os.environ.get("BM_REPORT_API", "https://report.open-aec.com")
...
class ReportApiClient:
    """Eenvoudige API client voor de OpenAEC Report Generator.

    Gebruikt Bearer token authenticatie (geen cookies nodig).
    Compatibel met pyRevit CPython 3.8+ en standaard Python 3.10+.

    Args:
        base_url: Basis URL van de API (bijv. "https://report.open-aec.com").
    """
