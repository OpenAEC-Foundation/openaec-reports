...
LOGO_PATH = Path(__file__).parent.parent.parent / "src" / "openaec_reports" / "assets" / "logos" / "3bm-cooperatie.png"
...
def main():
    ...
    if LOGO_PATH.exists():
        logo_image = ImageBlock(
            path=LOGO_PATH,
            width_mm=60,
            caption="Figuur 1 — 3BM Coöperatie logo (test afbeelding)",
            align="center",
        )
        report.add_section(
            "Bijlagen",
            ...
            content=[
                ...
                "het 3BM logo opgenomen als testafbeelding.",
                logo_image,
            ],
        )
