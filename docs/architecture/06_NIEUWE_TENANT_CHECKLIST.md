...
|---|---|---|
| `symitech_bic_factuur` | symitech | bic_factuur |
| `3bm_structural_report` | 3bm_cooperatie | structural_report |
| `acme_inspectie_rapport` | acme | inspectie_rapport |

De API herkent de tenant uit de template naam:
```
"symitech_bic_factuur" → tenant="symitech", template="bic_factuur"
```
...
```json
{
  "template": "symitech_bic_factuur",    // ← tenant_documenttype
