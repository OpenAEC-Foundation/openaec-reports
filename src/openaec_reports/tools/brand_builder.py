...
try:
    from openaec_reports.tools.config_generator import generate_analysis_report, generate_brand_yaml
    from openaec_reports.tools.page_classifier import PageType, classify_pages
...
class BrandBuilder:
    ...
    def build(
        ...
        print("  Gebruik 'openaec-report visual-diff' om te vergelijken met referentie.")
