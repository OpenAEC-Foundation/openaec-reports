...
Layer 3: FRONTEND (bm-reports-ui)     ← MONOREPO (frontend/)
...
| `src/bm_reports/core/renderer_v2.py` | **PyMuPDF renderer — pixel-perfect PDF met YAML templates** |
...
| `src/bm_reports/api.py` | FastAPI endpoints + StaticFiles mount (SPA serving) |
