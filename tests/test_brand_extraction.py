...
class TestMergeBrandYaml:
    ...
    def test_minimal_merge(self):
        ...
        assert parsed["fonts"]["heading"] == "GothamBold"
...
class TestGeneratePromptPackage:
    ...
    def test_basic_prompt(self):
        ...
        assert "# Brand Extraction — 3BM Test" in result
        assert "#40124A" in result
        assert "GothamBold" in result
...
class TestGetReferencePages:
    ...
    def test_returns_none_for_missing(self, tmp_path):
        """Retourneert None als 3bm_cooperatie niet bestaat."""
    ...
    def test_returns_pages_yaml(self, tmp_path):
        ...
        tenant_dir = tmp_path / "3bm_cooperatie"
        tenant_dir.mkdir()
