...
### Blokkade
- **Server deploy nodig** — Docker container op `report.open-aec.com` moet herbouwd worden (via PuTTY)
- **Deploy commando:** `cd /opt/openaec && docker compose pull bm-reports-api && docker compose up -d bm-reports-api`
