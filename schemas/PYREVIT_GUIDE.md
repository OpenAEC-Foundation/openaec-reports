# pyRevit Integratie — 3BM Report Generator API
...
De 3BM Report Generator API accepteert JSON en retourneert een PDF.
...
API_URL = "https://report.3bm.co.nl/api/generate/v2"
...
data = {
    ...
    "brand": "3bm_cooperatie",       # Huisstijl (default: 3bm_cooperatie)
...
```python
"""3BM Report Generator — pyRevit helper."""
import json
import base64
import requests
