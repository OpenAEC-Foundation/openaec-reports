...
STATIONERY_DIR = (
    BASE / "src" / "openaec_reports" / "assets" / "stationery" / "3bm_cooperatie"
)
TEMPLATE_DIR = BASE / "src" / "openaec_reports" / "assets" / "templates" / "3bm_cooperatie"
...
class TestPerSectionOrientation:
    ...
    def renderer(self) -> ContentRenderer:
        ...
        tpl = TemplateSet(brand="3bm_cooperatie")
        fonts = FontManager()
