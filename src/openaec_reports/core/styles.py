...
class Colors:
    """OpenAEC Huisstijl kleurenpalet."""
...
class FontConfig:
    ...
    Gebruikt Inter fonts als ze beschikbaar zijn in assets/fonts/.
    Valt automatisch terug op Helvetica als Inter niet geïnstalleerd is.
    """

    heading: str = "Inter-Bold"  # Fallback: Helvetica-Bold
    body: str = "Inter-Regular"  # Fallback: Helvetica
    medium: str = "Inter-Medium"  # Fallback: Helvetica
    italic: str = "Inter-RegularItalic"  # Fallback: Helvetica-Oblique
    mono: str = "Courier"
    body_size: float = 9.5
...
def _make_font_config() -> FontConfig:
    """Maak FontConfig met effectieve font namen (Inter of Helvetica fallback)."""
    _ensure_fonts_registered()
    return FontConfig(
        heading=get_font_name("Inter-Bold"),
        body=get_font_name("Inter-Regular"),
        medium=get_font_name("Inter-Medium"),
        italic=get_font_name("Inter-RegularItalic"),
    )
...
def create_stylesheet(brand: BrandConfig | None = None) -> StyleSheet1:
    ...
    styles.add(
        ParagraphStyle(
            ...
            fontName=BM_FONTS.body,  # Inter-Regular, NIET Bold
    ...
    styles.add(
        ParagraphStyle(
            name="Heading2",
            parent=styles["Normal"],
            fontName=BM_FONTS.body,  # Inter-Regular
